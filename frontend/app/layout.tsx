    ...
    <html lang="es">
      <body>
        <style>{`
          ...
          .employment-entry { width: min(1240px, calc(100% - 40px)); margin: 14px auto 0; padding: 0; }
          body:not(:has(.public-site)) .employment-entry { display: none; }
          .employment-entry-inner { display: flex; align-items: center; justify-content: space-between; gap: 24px; padding: 13px 18px; border: 1px solid #c9daf3; border-radius: 14px; background: linear-gradient(100deg, #eef5ff, #f8fbff); box-shadow: 0 8px 22px rgba(31, 55, 94, .06); }
          ...
          .employment-entry a { flex: 0 0 auto; display: inline-flex; align-items: center; min-height: 40px; padding: 8px 14px; border-radius: 9px; background: #1557c0; color: #fff; font-size: .88rem; font-weight: 800; text-decoration: none; }
          .employment-entry a:hover { background: #0d459f; }

          .public-process #materiales-proceso .process-content > * { display: none; }
          .public-process #materiales-proceso .process-content::before { content: "DESCUBRE"; display: block; color: #5c6b80; font-size: 12px; letter-spacing: 1.4px; font-weight: 800; margin-bottom: 8px; }
          .public-process #materiales-proceso .process-content::after { content: "Encuentra oportunidades de empleo público que encajan contigo. Sigue las convocatorias y sus novedades oficiales desde un mismo lugar."; display: block; color: #17315f; font-size: 1rem; line-height: 1.55; font-weight: 700; }

          .public-value-panel::after { content: "DESCUBRE OPORTUNIDADES DE EMPLEO PÚBLICO\\00000A\\00000AExplora convocatorias y sigue sus novedades oficiales.\\00000A\\00000AVer oportunidades →"; white-space: pre-wrap; display: block; margin-top: 6px; padding: 17px 18px; border: 1px solid #bcd1ee; border-radius: 14px; background: #eef5ff; color: #1557c0; font-size: .9rem; line-height: 1.45; font-weight: 800; }

          .public-hero-copy > p { font-size: 0 !important; }
          .public-hero-copy > p::after { content: "Tu Coach combina simulacros, tests dirigidos y análisis de tus respuestas para que practiques con criterio y detectes dónde necesitas reforzar."; font-size: 1.12rem; }
          .public-proof-heading p { font-size: 0 !important; }
          .public-proof-heading p::after { content: "Tu Coach acompaña todo el ciclo de entrenamiento: eliges qué practicar, respondes, corriges y utilizas lo aprendido para decidir dónde concentrar el siguiente esfuerzo."; font-size: 1rem; }
          .public-highlight p { font-size: 0 !important; }
          .public-highlight p::after { content: "Tu Coach reúne contenido y herramientas para que puedas estudiar, consultar y analizar tu preparación dentro de tu convocatoria."; font-size: 1rem; }
          .public-pricing h2 { font-size: 0 !important; }
          .public-pricing h2::after { content: "Prueba Tu Coach antes de suscribirte"; font-size: 2rem; }
          ...
          .public-final-cta h2::after { content: "Haz tu primer test y comprueba cómo trabaja Tu Coach."; font-size: 2rem; }
