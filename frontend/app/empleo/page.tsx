        ...
        <section style={styles.panel}>
          ...
          {procesos.length === 0 ? <p>No hay convocatorias activas.</p> : <div style={styles.cards}>
            {procesos.map(p => {
              ...
              const seguida = suscripciones.some(s => s.proceso_id === p.id);
              return (
...
const styles: Record<string, React.CSSProperties> = {
  ...
  cardLayout: { display: "flex", justifyContent: "space-between", gap: 18, alignItems: "center", padding: 0 },
  cardButton: { flex: 1, minWidth: 0, border: 0, background: "transparent", textAlign: "left", padding: 16, cursor: "pointer" },
